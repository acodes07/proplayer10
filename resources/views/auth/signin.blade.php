...
<head>
    ...
    <title>Sign In - ProPlayer#10</title>
...
<body>
    <div class="auth-container">
        ...
        <div class="auth-header">
            ...
            <p class="auth-subtitle">Sign in to your ProPlayer#10 account</p>
        </div>
        ...
        <div class="auth-footer">
            <p>Don't have an account? <a href="{{ route('signup') }}" class="auth-link">Sign Up</a></p>
        </div>
    </div>
